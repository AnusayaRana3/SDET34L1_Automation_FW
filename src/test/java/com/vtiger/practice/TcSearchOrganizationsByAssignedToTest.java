...
public class TcSearchOrganizationsByAssignedToTest {
...
String organizationname=ExcelCommonClassUtility.getDataFromExcel("Contacts", 8, 1)+randomnumber;
	...
	//Navigate to Organizations
		...
		//driver.findElement(By.xpath("//td[@class='fdvtCellLabel']//following-sibling::td[1]//input[@value='U']")).click();
		...
		driver.findElement(By.xpath("//input[@class='txtBox']")).sendKeys("a");
		WebElement dropdown=driver.findElement(By.xpath("//select[@id='bas_searchfield']"));
		WebDriverUtility.initializeSelectClass(dropdown);
		WebDriverUtility.dropDownHandleByValue("assigned_user_id", dropdown);
