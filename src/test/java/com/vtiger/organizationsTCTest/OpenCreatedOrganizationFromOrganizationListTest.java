...
public class OpenCreatedOrganizationFromOrganizationListTest extends BaseClass {
	...
	@Test
	public void openCreatedOrganizationFromOrganizationListByTestNgTest() {
		...
		information= organizationInformationPage.getOrganizationInformationMsg();
		javaClassUtility.printStatement(information);
